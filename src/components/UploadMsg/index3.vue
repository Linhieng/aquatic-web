    ...
    <div class="body">
      <div class="forms">
        ...
        >
          ...
          <el-form-item label="产品产地" prop="originPlace">
...
export default {
  data() {
    ...
    const rules = {
        ...
        carKind: [ { required: true, message: "请输入车辆类型", trigger: "blur" }, ],
        ...
        departureDatetime: [ { required: true, message: "请输入出发时间", trigger: "blur" }, ],
        loadTime: [ { required: true, message: "请输入装车时间", trigger: "blur" }, ],
        productQRCode: [ { required: true, message: "请输入水产品ID", trigger: "blur" }, ],
        productName: [ { required: true, message: "请输入水产品名称", trigger: "blur" }, ],
        originPlace: [{ required: true, message: "请输入产地", trigger: "blur" }],
        seaProductDescription: [ { required: true, message: "请输入水产品描述", trigger: "blur" }, ],
